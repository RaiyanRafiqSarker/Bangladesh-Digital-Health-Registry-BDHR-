            ...
            <tr>
                ...
                <td>
                    <?php if ($row['status'] == 'Pending') { ?>
                        <a href="../Controllers/DoctorVerificationController.php?action=approve&id=<?php echo $row['id']; ?>">
                            <button type="button">Approve</button>
                        </a>
                        <br><br>
                        <a href="../Controllers/DoctorVerificationController.php?action=reject&id=<?php echo $row['id']; ?>">
